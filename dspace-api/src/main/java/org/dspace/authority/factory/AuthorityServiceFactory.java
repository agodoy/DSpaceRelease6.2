...
/**
 * Abstract factory to get services for the authority package, use
 * AuthorityServiceFactory.getInstance() to retrieve an implementation
 *
...
public abstract class AuthorityServiceFactory {
	...
	public static AuthorityServiceFactory getInstance() {
		return DSpaceServicesFactory.getInstance().getServiceManager().getServiceByName("authorityServiceFactory",
				AuthorityServiceFactory.class);
	}
